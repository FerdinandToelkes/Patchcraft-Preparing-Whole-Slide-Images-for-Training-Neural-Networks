...
# example of usage: 
# screen -dmS sample_tiles0 sh -c 'docker run --name ftoelkes_run0 -it -u `id -u $USER` --rm -v /home/ftoelkes/code/patchcraft:/patchcraft -v /data/sqlite:/data ftoelkes_patchcraft ../generate_tiles.sh  ../train_1024um_patches --input_path=/data --patch_size_um=1024 -pps all --mode "train" --white_threshold=0.25 -rp=1 --highest_zoom_level --overlap --number_of_slides=40 --start_slide=0; exec bash'
